...
#define OLD_MAX_K 8 // the max value of k for which we will use previous method. And we will use it for base of smaller_canon_map
...
#else
#define maxBk (1 << (OLD_MAX_K*(OLD_MAX_K-1)/2 + OLD_MAX_K*SELF_LOOPS))
#endif
