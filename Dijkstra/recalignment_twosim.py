...
class Alignment:
    def __init__(self, seed, m, ec_mode, ed, sb, sb2, alpha, delta, seedname, outputdir,timestop, alignstop):
...
def printoutput(g1, g2, curralign):
    ...
    #print("O. output_file ", output_file);
...
def append_result(g1,g2, curralign):
    ...
    #print("P. output_file ", output_file);
    with open(output_file, 'a')as f:
...
def rec_align(g1, g2, seed, sims, seqsims, ec_mode, ed, m, sb, sb2, delta, alpha, seedname, outputdir, alignstop, timestop=None,  debug=False):
    ...
    curralign = Alignment(seed, m, ec_mode, ed, sb, sb2,  alpha, delta, seedname, outputdir, timestop, alignstop)
...
def write_result(g1,g2, curralign):
    ...
    Path(output_dir).mkdir(parents=True, exist_ok=True)
    output_file = output_dir + "/" + fname
    #print("Q. output_file ", output_file);
