...
def initParser():
    ...
    parser.add_argument("-g1", "--graph1", required=False, default = "/home/sana/networks/MMusculus-3.5.174.el", help ="first graph file")
    parser.add_argument("-g2", "--graph2", required=False, default = "/home/sana/networks/HSapiens-3.5.174.el", help ="second graph file")
    parser.add_argument("-s", "--sim", required=False, default = "/home/sana/sims/Importance/MMusculus-3.5.174--HSapiens-3.5.174.sim.xz", help ="sim file")
    parser.add_argument("-d", "--delta", required=False, default = 0.01, help ="delta value")
    parser.add_argument("-g1sline", "--g1seedline", required=False, default = 0, help ="g1 seed file line")
    parser.add_argument("-g2sline", "--g2seedline", required=False, default = 79, help ="g2 seed file")
    parser.add_argument("-r", "--runs", required=False, default = 1, help = "number of times to run")
    parser.add_argument("-g1s", "--g1seed", required=False, default = "/home/hanweny/BLANT/seeds/alignment_seeds_unambig/MMusculus_8_25_150000_uDMAX_e0.5.txt", help ="g1 seed file")
    parser.add_argument("-g2s", "--g2seed", required=False, default = "/home/hanweny/BLANT/seeds/alignment_seeds_unambig/HSapiens_8_25_150000_uDMAX_e0.5.txt", help ="g2 seed file")
    parser.add_argument("-pk", "--pickle", required=False, default = "", help = "location of existing pickle file")

    parser.add_argument("-ec1", "--ec1bound", required=False, default = 0, help ="lower bound for ec1")
    parser.add_argument("-ec2", "--ec2bound", required=False, default = 0, help ="lower bound for ec2")
    ...
    parser.add_argument("-ed", "--edbound", required=False, default = 0, help = "edge density lower bound")
    parser.add_argument("-t", "--timestop", required=False, default = 0.01, help = "Stop program after specified time, units in hours")
    ...
    parser.add_argument("-sn", "--seednum", required=False, default = 5000, help = "seed num")
